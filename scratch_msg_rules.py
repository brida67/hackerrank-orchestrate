...
def get_message_rules(user_id):
    ...
    for _, msg in u_msgs.iterrows():
        ...
        # Contract ended e.g. user_12 "The current seasonal contract has ended. No off-season income or renewal has been confirmed."
        if 'seasonal contract has ended' in txt or 'No off-season income' in txt:
            rules['stop_off_season_salary'] = True
            
        # Childcare payment e.g. user_14
...
print("Loaded message rules extractor.")
